namespace Compiler.Nodes
{
    ...
    /// </summary>
    public class BinaryOperationDeclarationNode
    {
        /// <summary>
        ...
        public BinaryOperationDeclarationNode(string name, SimpleTypeDeclarationNode leftType, SimpleTypeDeclarationNode rightType, SimpleTypeDeclarationNode returnType)
        {
            Name = name;
