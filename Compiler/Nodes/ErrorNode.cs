...
namespace Compiler.Nodes
{
    ...
    /// </remarks>
    public class ErrorNode : IAbstractSyntaxTreeNode, ICommandNode, IDeclarationNode, IDeclaredNode, IExpressionNode, IParameterNode, ITypeDeclarationNode, ITypedNode, IVariableDeclarationNode
    {
        /// <summary>
