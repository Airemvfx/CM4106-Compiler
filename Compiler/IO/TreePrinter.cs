    ...
    public static class TreePrinter
    {
        ...
        private static string ToString(ImmutableList<bool> lastChild, IAbstractSyntaxTreeNode node)
        {
            switch (node)
            {
                ...
                // Declarations
                case SingleDeclarationNode singleDeclaration:
                    return NodeToString(lastChild, singleDeclaration, singleDeclaration.TypeDenoter, singleDeclaration.Identifier, singleDeclaration.Initializer);
                ...
                case ValueParameterNode valueParameter:
                    return NodeToString(lastChild, valueParameter, valueParameter.Expression);
        ...
        {
            return node.GetType().GetProperties()
                       .Where(property => property.PropertyType == typeof(Token))
